...
exports.findProfileProjects = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var projects, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, prisma.profileProject.findMany({
                        where: {
                            profile: {
...
exports.findProfileProject = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var project, error_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, prisma.profileProject.findUnique({
                        where: {
...
exports.createProfileProject = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var project, error_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, prisma.profileProject.create({
...
exports.updateProfileProject = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var project, error_4;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, prisma.profileProject.update({
                        where: {
                            slug: req.params.projectSlug,
                            profile: {
                                slug: req.params.profileSlug
...
exports.deleteProfileProject = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var project, error_5;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, prisma.profileProject["delete"]({
                        where: {
                            slug: req.params.projectSlug,
                            profile: {
                                slug: req.params.profileSlug
