...
exports.findProfileSkills = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var skills, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, prisma.profileSkill.findMany({
                        where: {
                            profile: {
...
exports.findProfileSkill = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var skill, error_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, prisma.profileSkill.findUnique({
                        where: {
...
exports.createProfileSkill = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var skill, error_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, prisma.profileSkill.create({
...
exports.updateProfileSkill = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var skill, error_4;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, prisma.profileSkill.update({
                        where: {
                            slug: req.params.skillSlug,
                            profile: {
                                slug: req.params.profileSlug
...
exports.deleteProfileSkill = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var skill, error_5;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, prisma.profileSkill["delete"]({
                        where: {
                            slug: req.params.skillSlug,
                            profile: {
                                slug: req.params.profileSlug
